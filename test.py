...
for iter in range(1,iter_range+1):
      ...
      try:
          ...
          try:
              ...
              print(
                  "now .. I'm almost sure that data table name does not exist yet in this db .. so stop trying to drop ... but fck man why shold I monitor this shit? start being more attentive ...")
